...
1. To get started with connector configurations, see [Configuring googleAdNetwork Connector](docs/config.md).
2. Follow [Working with googleAdNetwork Connector](docs/operations.md) for information on the connector operations.
